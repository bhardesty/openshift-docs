...
. Install the {oc} from the {rosa-cli}.
...
.. After downloading the {oc}, extract it and add it to your path.
.. Enter this command to verify that the {oc} is installed correctly:
+
[source,terminal]
----
$ rosa verify oc
